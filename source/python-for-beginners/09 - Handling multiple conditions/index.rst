...
Conditional execution can be completed using the `if <https://docs.python.org/3/reference/compound_stmts.html#the-if-statement>`_ statement. Adding `elif` allows you to check multiple conditions
...
.. literalinclude:: nested_if.py
   :language: python
   :linenos:

.. literalinclude:: multiple_if_statements.py
   :language: python
   :linenos:

.. literalinclude:: add_else_to_elif.py
   :language: python
   :linenos:
...
.. raw:: html
    ...
    <div class="slideshow">
            ...
            <iframe style="border: none; width: 100%; height: 402px" name="embedded_lecture1_anywhere" src="../../_static/P4All_Lecture10/main.html"></iframe>
